...
//document.write(`<h1><center>Total cost of <b>${tkt}</b> tickets is : <b>${tkt*600}</b> PKR.</center></h1>`);
...
document.write(`sum of ${b} and ${a} is: ${sum} <br>`);
...
if (x === "nadeem");{
   ...
   //console.log("Muhammad nadeem Soomro");
   ...
   if (x === "sindh"){
      document.write("not province type city name");
   }*/
   ...
   console.log(`Minus of ${a} and ${b} is : ${sub}`);
